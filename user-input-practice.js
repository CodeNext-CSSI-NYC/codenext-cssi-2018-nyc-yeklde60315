 ...
 console.log("The sqaure root of"+number+"is"+(Math.sqrt(number)));
 ...
 console.log("Your name has"+ name.length +"letter");
...
var readline= require("readline-sync");
var word=readline.question("Please enter a word ?");
console.log("The word " + word + " start with the letter " + word.charAt( 0 ));


 // 4. Ask the user to enter two numbers, and print out "The average of ___ and ___ is ____", but with the blanks filled in.

let readline= require("readline-sync");
let x= parseFloat(readline.question("enter one numbers:"));
let y= parseFloat(readline.question("enter two numbers:"));

console.log(" The average of " + x + " and " + y + " is " + (y+x)/2);
